<div class="antialiased bg-laravel-pink">
  <div class="w-full text-laravel-pink bg-azure-blue">
    <div x-data="{ open: false }"
      class="flex flex-col max-w-screen-xl px-4 mx-auto md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
      <div class="flex flex-row items-center justify-between p-4">
        <a href="{{ route('home') }}" class="text-xl tracking-widest font-bold text-laravel-pink hover:text-laravel-pink-darker rounded-lg focus:outline-none
