        ...
        <div class="control-menus">
            ...
            <nav class="control-panels">
                ...
                <a class="flex items-start rounded-lg bg-transparent p-2 hover:text-gray-900 hover:bg-gray-200 cursor-pointer"
                    ...
                    <div class="bg-laravel-pink-darker text-white rounded-lg p-3 lg:py-2">
        ...
        <div
            ...
            <div class="modal-content py-4 text-left px-6">
                ...
                <div class="flex justify-end pt-2">
                    ...
                    <button
                        class="focus:outline-none px-4 bg-laravel-pink-darker p-3 ml-3 rounded-lg text-white hover:bg-laravel-pink-darker-darker"
