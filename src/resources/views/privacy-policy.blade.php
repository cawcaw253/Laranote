...
@section('content')
<div class="w-full md:w-1/3 md:pr-16 order-3 md:order-1">
    <div class="max-w-md md:float-right md:text-right leading-loose tracking-tight md:sticky md:top-0 ">
        <p class="font-bold my-4 md:my-12">Privacy Policy</p>
...
<div class="w-full md:w-1/2 order-1 md:order-2">
    <div class="max-w-md leading-loose tracking-tight docs">
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                    &quot;Us&quot; or
                    &quot;Our&quot; in this Agreement) refers to LaraNote.</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to LaraNote, accessible from <a href="https://www.laranote.net"
                        rel="external nofollow noopener" target="_blank">https://www.laranote.net</a></p>
            </li>
            <li>
        ...
        <ul>
            <li>By email: detectiveCrow2540@gmail.com</li>
        </ul>
    </div>
</div>
@stop