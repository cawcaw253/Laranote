...
const berry_red_lighter = '#FECACA' // colors.red.200
const berry_red = '#F87171' // colors.red.400
const berry_red_darker = '#F87171' // colors.red.600
  ...
  theme: {
    extend: {
      colors: {
        ...
        'berry-red-lighter': berry_red_lighter,
        'berry-red': berry_red,
        'berry-red-darker': berry_red_darker,
      },
      typography: (theme) => ({
        DEFAULT: {
          css: {
